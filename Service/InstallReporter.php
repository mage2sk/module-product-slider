<?php
/**
 * Standalone install + heartbeat reporter for Panth_ProductSlider.
 *
...
namespace Panth\ProductSlider\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_ProductSlider';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-product-slider';
