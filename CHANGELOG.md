...
### Changed
- Rewrote README to match current module structure: accurate system.xml
  configuration table (General Settings + Default Layout groups), correct
  db_schema columns, confirmed embed methods (widget UI, layout XML, CMS
  directive), and updated live product page canonical URL.
